...
public class CPFValidador {
	...
	// teste pra verificar se o cpf é válido (usando o cpf válido que estava na explicação)
	@Test
	...
	// teste pra verificar se o cpf é válido (usando o cpf inválido que estava na explicação)
	@Test
	...
	// teste pra verificar se o cpf é válido (usando um outro cpf válido pego no link: https://www.4devs.com.br/gerador_de_cpf)
	@Test
